  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm text-on-surface-variant mt-1">Manage which emails you receive from Avolo.</p>
      </div>
      ...
      {loading ? (
        ...
        <section className="flex flex-col divide-y divide-outline-variant rounded-2xl border border-outline-variant overflow-hidden">
            ...
            <div key={key} className="flex items-center justify-between gap-4 p-5">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:opacity-60 ${
                  settings[key] ? "bg-primary" : "bg-surface-container"
                }`}
              >
                <span
